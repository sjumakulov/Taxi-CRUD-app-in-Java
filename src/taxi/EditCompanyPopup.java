...
import static taxi.editFunctions.saveEditedCompany;
import static taxi.functions.randomColor;

public class EditCompanyPopup {

    public static void showEditCompanyPopup(JFrame FRAME, JPanel companyNameContainer) {
        GlassPane glassPane = new GlassPane();
        FRAME.getRootPane().setGlassPane(glassPane);

        glassPane.setVisible(true);
        companyDialogPopup(FRAME, companyNameContainer);
        glassPane.setVisible(false);
    }

    public static JDialog companyDialogPopup(JFrame FRAME, JPanel companyNameContainer) {
        ...
        gbc.gridx = 0;
        gbc.gridy = 0;
        jd.add(stringDataEntry("Фирма номи:", companyNameContainer), gbc);

        gbc.gridwidth = 1;
        gbc.gridx = 0;
        gbc.gridy = 1;
        jd.add(button("Бекор қилиш", "cancel", jd, companyNameContainer), gbc);

        gbc.gridwidth = 1;
        gbc.gridx = 1;
        gbc.gridy = 1;
        jd.add(button("Сақлаш", "save", jd, companyNameContainer), gbc);
    ...
    public static JPanel stringDataEntry(String dataLabel, JPanel companyNameContainer) {
        String company_name = ((JLabel) companyNameContainer.getComponent(0)).getText();
        Color company_color = ((JPanel) companyNameContainer.getComponent(1)).getBackground();
        ...
        textField.setText(company_name);

        JPanel colorPanel = new JPanel();
        colorPanel.setBackground(company_color);
    ...
    private static JButton button(String label, String name, JDialog jd, JPanel companyNameContainer) {
        ...
        button.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (name.equals("cancel")) {
                    ...
                    saveEditedCompany(jd, companyNameContainer);
